      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-12 border-b border-gray-800 pb-8">
          ...
          <div className="flex gap-4 self-start md:self-center">
            <a href="#" className="w-10 h-10 border border-white/20 rounded-full flex items-center justify-center hover:bg-white hover:text-vakya-black transition-colors group" aria-label="YouTube">
            ...
            <a href="#" className="w-10 h-10 border border-white/20 rounded-full flex items-center justify-center hover:bg-white hover:text-vakya-black transition-colors group" aria-label="Instagram">
            ...
            <a href="#" className="w-10 h-10 border border-white/20 rounded-full flex items-center justify-center hover:bg-white hover:text-vakya-black transition-colors group" aria-label="Twitter">
            ...
            <a href="#" className="w-10 h-10 border border-white/20 rounded-full flex items-center justify-center hover:bg-white hover:text-vakya-black transition-colors group" aria-label="Patreon">
        ...
        <div className="flex flex-wrap gap-x-8 gap-y-4 font-sans font-bold text-sm uppercase tracking-widest mb-12 text-gray-300">
          ...
          <Link to="/about" className="hover:text-white hover:underline decoration-2 underline-offset-4">Our Staff</Link>
          <span className="text-gray-700">|</span>
