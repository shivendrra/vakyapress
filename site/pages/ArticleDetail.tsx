...
import { getRelatedArticles, getArticleById, getStaffBySlug } from '../services/firebase';
...
const ArticleDetail: React.FC = () => {
  ...
  const [authorProfile, setAuthorProfile] = useState<StaffProfile | null>(null);
    ...
    if (id) {
      ...
      getArticleById(id).then(fetchedArticle => {
        ...
        if (fetchedArticle) {
          ...
          // Fetch dynamic author profile
          const slug = getAuthorSlug(fetchedArticle.author);
          getStaffBySlug(slug).then(profile => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 space-y-12">
            ...
            {/* Author Card - Removed sticky positioning to fix overlap issue */}
              ...
              <div className="flex items-center gap-4 mb-4">
                <div className="relative">
                  ...
                  <Link to={`/staff/${getAuthorSlug(article.author)}`}>
                    <img
                      src={authorProfile?.image || article.authorImage || `https://ui-avatars.com/api/?name=${article.author}`}
                ...
                <div>
                  ...
                  <p className="font-sans text-xs font-bold text-gray-400 uppercase tracking-widest">
                    {authorProfile?.title || "Writer at Vakya"}
                  </p>
                </div>
              </div>

              <p className="font-sans text-sm text-gray-600 mb-6 leading-relaxed">
                {authorProfile?.bio || `Journalist covering ${article.category.toLowerCase()} and human interest stories. Believes in the power of unhurried reporting.`}
              </p>
